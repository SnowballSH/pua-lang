...
(function () {
  ...
  var grammar = {
    ...
    ParserRules: [
      ...
      {
        name: "varAccess",
        symbols: [lexer.has("iden") ? { type: "iden" } : iden],
        postprocess: ([a]) => {
          return {
            type: "varAccess",
            name: a.value,
      ...
      {
        name: "_$ebnf$1",
        symbols: ["_$ebnf$1", "_$ebnf$1$subexpression$1"],
